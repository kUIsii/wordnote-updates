...
public final class CategoryDao_Impl implements CategoryDao {
  ...
  public CategoryDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfCategory = new EntityInsertionAdapter<Category>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `categories` (`id`,`name`,`color`,`isDefault`) VALUES (nullif(?, 0),?,?,?)";
      }
    ...
    this.__updateAdapterOfCategory = new EntityDeletionOrUpdateAdapter<Category>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `categories` SET `id` = ?,`name` = ?,`color` = ?,`isDefault` = ? WHERE `id` = ?";
      }
      ...
      public List<Category> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Category(_tmpId,_tmpName,_tmpColor,_tmpIsDefault);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getAllCategoriesSync(final Continuation<? super List<Category>> arg0) {
    final String _sql = "SELECT * FROM categories ORDER BY isDefault DESC, name ASC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
  ...
  @Override
  public Object getCategoryById(final long categoryId, final Continuation<? super Category> arg1) {
      ...
      public Category call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _tmp = _cursor.getInt(_cursorIndexOfIsDefault);
            _tmpIsDefault = _tmp != 0;
            _result = new Category(_tmpId,_tmpName,_tmpColor,_tmpIsDefault);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public Object getCategoryByName(final String name, final Continuation<? super Category> arg1) {
  ...
  @Override
  public Object getWordCountForCategory(final long categoryId,
      final Continuation<? super Integer> arg1) {
    final String _sql = "SELECT COUNT(*) FROM words WHERE categoryId = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindLong(_argIndex, categoryId);
    final CancellationSignal _cancellationSignal = DBUtil.createCancellationSignal();
