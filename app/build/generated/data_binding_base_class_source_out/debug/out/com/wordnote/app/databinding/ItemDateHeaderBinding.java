...
public final class ItemDateHeaderBinding implements ViewBinding {
  ...
  private ItemDateHeaderBinding(@NonNull LinearLayout rootView, @NonNull TextView dateTextView) {
  ...
  public static ItemDateHeaderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemDateHeaderBinding((LinearLayout) rootView, dateTextView);
    }
