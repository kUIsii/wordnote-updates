...
abstract class WordDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        val MIGRATION_8_9 = object : Migration(8, 9) {
            override fun migrate(database: SupportSQLiteDatabase) {
                database.execSQL("ALTER TABLE word_meanings ADD COLUMN sortOrder INTEGER NOT NULL DEFAULT 0")
            }
        }
        ...
        val MIGRATION_10_11 = object : Migration(10, 11) {
            override fun migrate(database: SupportSQLiteDatabase) {
                database.execSQL("ALTER TABLE words ADD COLUMN isDeleted INTEGER NOT NULL DEFAULT 0")
                database.execSQL("ALTER TABLE words ADD COLUMN deletedAt INTEGER NOT NULL DEFAULT 0")
            }
        }
        ...
        val MIGRATION_14_15 = object : Migration(14, 15) {
            override fun migrate(database: SupportSQLiteDatabase) {
                database.execSQL("ALTER TABLE word_groups ADD COLUMN color TEXT DEFAULT NULL")
                database.execSQL("ALTER TABLE word_groups ADD COLUMN sortOrder INTEGER NOT NULL DEFAULT 0")
            }
        }
